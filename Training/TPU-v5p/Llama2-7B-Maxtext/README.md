...
Please check the v4 user guide first [here](https://github.com/gclouduniverse/reproducibility/blob/main/Training/TPU-v4/Llama2-7B-Maxtext/README.md) for more basic concepts.
